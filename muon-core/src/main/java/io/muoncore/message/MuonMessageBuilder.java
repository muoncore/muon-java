...
public class MuonMessageBuilder {
  ...
  public MuonMessageBuilder toServiceInstance(String service, String instance) {
  ...
  public MuonOutboundMessage build() {
    return new MuonOutboundMessage(
      id, created, targetServiceName, targetInstance, sourceServiceName, protocol, step, status, payload, contentType, channelOperation);
  }
