...
```java
include::{includedir}/src/main/java/io/muoncore/example/MuonClientExample.java[tags=config]
```
...
```java
include::{includedir}/src/main/java/io/muoncore/example/ManualMuonBuild.java[tags=transport]
```
