...
```
include::src/main/groovy/io/muoncore/example/Introduction.groovy[lines=7..21]
```
...
Service discovery is baked into the core of Muon, and every implementation has a similar looking subsystem.
