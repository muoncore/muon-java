...
Finish this event guide.
Write up the event guide with a concrete example
...
systems. The Muon ecosystem provides special support for building event based systems, in the form of :=
...
Eventing in Muon is taken to mean persisted event architectures, where the streams of events are stored
